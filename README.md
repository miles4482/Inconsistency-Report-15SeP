...
- **MML Object**, **Parameter ID**, and **Parameter Name** are the three columns used to find each parameter in the dump. Other reference columns (Proposed / Recommended / Plan value, **Conditions**, bands, groups) are detected automatically.
